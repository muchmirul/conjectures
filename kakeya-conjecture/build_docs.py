"""Build the web version of this topic's article from ARTICLE.md.
    ...
    cd kakeya-conjecture && make docs        (or: ../.venv/bin/python build_docs.py)

Writes ../docs/kakeya-conjecture/index.html, the polished one-page version:
...
<title>Kakeya's Needle, from Zero</title>
<meta name="description" content="An illustrated guide, starting from zero, to the Kakeya needle problem: why there is no smallest room, and how the three dimensional conjecture fell in February 2025.">
<script>
MathJax = {
  tex: { inlineMath: [['$', '$'], ['\\\\(', '\\\\)']],
         displayMath: [['$$', '$$'], ['\\\\[', '\\\\]']] },
