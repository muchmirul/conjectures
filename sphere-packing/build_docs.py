"""Build the web version of this topic's article from ARTICLE.md.
    ...
    cd sphere-packing && make docs        (or: ../.venv/bin/python build_docs.py)

Writes ../docs/sphere-packing/index.html, the polished one-page version:
...
def embed_simulations(body: str) -> str:
    ...
    return body.replace(
        "https://muchmirul.github.io/conjectures/sphere-packing/play/", "play/")
